"""
Journal Controller - API Layer Only
This controller handles HTTP requests/responses and delegates to domain service.
...
def _enqueue_analysis(entry_id: str, user_id: str, entry_text: dict) -> None:
    ...
    queue.enqueue(
        "app.workers.worker.run_psychometric_analysis",
        entry_id=entry_id,
        user_id=user_id,
